...
`;t.default=c},147:function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const a=n(0);t.default=(e,t)=>{const[n,o]=a.useState(NaN);return a.useEffect(()=>{const a=()=>{const a=t&&t.current&&t.current.getBoundingClientRect(),i=(a?a.width:0)/e;i!==n&&o(i)};return Number.isNaN(n)&&a(),window.addEventListener("resize",a),()=>{window.removeEventListener("resize",a)}},[n]),{height:Number.isNaN(n)?"":n+"px"}}},148:function(e,t,n){"use strict";var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const o=a(n(0)),i=a(n(1)),r=a(n(17)),l=n(27),u=i.default(e=>{const{page:t,...n}=e;return o.default.createElement(r.default,Object.assign({page:t},n),t.contents.map((e,t)=>"text"===e.type?o.default.createElement(l.TextContent,{key:t,content:e}):"vimeo"===e.type?o.default.createElement(l.VimeoContent,{key:t,content:e}):o.default.createElement(l.FileContent,{key:t,content:e})))}).withConfig({displayName:"ContentPage",componentId:"sc-3iamhq"})`
    align-items: flex-start;
`;t.default=u},149:function(e,t,n){"use strict";var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const o=a(n(0)),i=a(n(17)),r=n(14),l=a(n(1)),u=a(n(4)),c=a(n(29)),s=l.default.div.withConfig({displayName:"MenuPortrait",componentId:"sc-1a6hth7"})`
...
`;t.default=r},4:function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0});t.IS_DEV=!1;const n="undefined"==typeof window?"":origin;t.HOST=n,t.default=n}).call(this,n(9))},42:function(e,t,n){"use strict";var a=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t};Object.defineProperty(t,"__esModule",{value:!0}),n(43);const o=n(157),i=n(4);function r(){try{const e=document.getElementById("global-mechanic-ssr"),t=e&&e.innerText;return t&&JSON.parse(t)||[]}catch(e){return i.IS_DEV&&console.error("could not parse json tag",e),[]}}window.onload=async function(){const e=await Promise.resolve().then(()=>a(n(0))),{hydrate:t}=await Promise.resolve().then(()=>a(n(45))),{BrowserRouter:i}=await Promise.resolve().then(()=>a(n(14))),{default:l}=await Promise.resolve().then(()=>a(n(54)));t(e.createElement(i,null,e.createElement(l,{initialPageData:r(),lightStaticAssets:o.light,darkStaticAssets:o.dark})),document.getElementById("global-mechanic-www"))}},54:function(e,t,n){"use strict";var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const o=a(n(55));t.default=o.default},55:function(e,t,n){"use strict";var a=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t},o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const i=a(n(0)),r=n(1),l=o(n(16)),u=o(n(60)),c=o(n(152)),s=o(n(153)),d=o(n(154)),f=o(n(156)),m=o(n(10));t.default=e=>{const{initialPageData:t,lightStaticAssets:n,darkStaticAssets:a}=e,o=t.map(e=>e.theme).find(e=>e)||"light",[h,p]=i.useState(o),g=f.default[h],_="dark"===h?n:a;return i.default.createElement(l.default,{initialPageData:t},i.default.createElement(m.default.Provider,{value:_},i.default.createElement(r.ThemeProvider,{theme:g},i.default.createElement(c.default,null),i.default.createElement(s.default,null,i.default.createElement(d.default,{navIconTo:"/menu"}),i.default.createElement(u.default,{setThemeType:p})))))}},56:function(e,t,n){"use strict";var a=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t},o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const i=a(n(0)),r=o(n(57)),l=i.createContext([]);t.PageDataContext=l;t.default=e=>{const{initialPageData:t=[],children:n}=e,[a,o]=i.useState(t);return i.useEffect(()=>{r.default().then(o)},[]),i.default.createElement(l.Provider,{value:a},n)}},57:function(e,t,n){"use strict";var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const o=a(n(58)),i=n(4);t.default=async function(){const e=await o.default(`${i.HOST}/data`);return await e.json()}},60:function(e,t,n){"use strict";var a=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t},o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const i=a(n(0)),r=n(14),l=n(16),u=n(61),c=o(n(151)),s=e=>{const{setThemeType:t}=e,n=i.useContext(l.PageDataContext).find(e=>!e.path);return n?i.default.createElement(u.SplashPage,{page:n,setThemeType:t}):i.default.createElement("span",null,"LOADING")},d=e=>{const{setThemeType:t}=e,n=(()=>{const e=r.useLocation().pathname.split("/").filter(e=>!!e);return e[e.length-1]})(),a=c.default(n),o=i.useContext(l.PageDataContext),s=o.find(a);return s?"content"===s.type?i.default.createElement(u.ContentPage,{page:s,setThemeType:t}):i.default.createElement(u.MenuPage,{page:s,pages:o,setThemeType:t}):i.default.createElement(u.MissingPage,null)};t.default=e=>i.default.createElement(r.Switch,null,i.default.createElement(r.Route,{path:"/",exact:!0},i.default.createElement(s,Object.assign({},e))),i.default.createElement(r.Route,{path:"/*"},i.default.createElement(d,Object.assign({},e))))},61:function(e,t,n){"use strict";var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const o=a(n(62));t.SplashPage=o.default;const i=a(n(148));t.ContentPage=i.default;const r=a(n(149));t.MenuPage=r.default;const l=a(n(150));t.MissingPage=l.default},62:function(e,t,n){"use strict";var a=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t},o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const i=a(n(0)),r=a(n(1)),l=o(n(17)),u=n(16),c=n(10),s=o(n(4)),d=n(27),f=r.css`
    ...
    overflow: hidden;
    z-index: -100;
`,m=r.default.span.withConfig({displayName:"BackgroundOverlay",componentId:"sc-9d82kl"})`
    ${f}
    background-image: url(${e=>e.staticImage});
`,h=r.default(e=>{const{fileId:t,...n}=e;return i.default.createElement("div",Object.assign({},n),i.default.createElement("video",{muted:!0,loop:!0,autoPlay:!0},i.default.createElement("source",{src:`${s.default}/file/${t}`})))}).withConfig({displayName:"BackgroundVideo",componentId:"sc-1yz4pi5"})`
    ${f}
...
`,p=r.default.h1.withConfig({displayName:"BackgroundText",componentId:"sc-1vhdl66"})`
    color: transparent;
    margin: 0;
...
`,g=r.default(e=>{const{page:t,...n}=e,a=c.useStaticAssets(),o=t.contents.find(e=>"text"===e.type),r=t.contents.find(e=>"file"===e.type),s=i.useContext(u.PageDataContext),f=s&&s.find(e=>"about"===e.path),g=f&&f.contents[0];return i.default.createElement(l.default,Object.assign({page:t},n),r?i.default.createElement(h,{fileId:r.file}):null,i.default.createElement(m,{staticImage:a.dots}),o?i.default.createElement(p,null,o.text):null,g?i.default.createElement(d.TextContent,{style:{color:"white",width:"max(50vw, 42em)"},content:g}):null)}).withConfig({displayName:"SplashPage",componentId:"sc-1louq4"})`
    align-items: center;
    justify-content: center;
    overflow-x: hidden;
    margin: auto;
`;t.default=g},63:function(e,t,n){"use strict";var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const o=a(n(0)),i=a(n(1)),r=a(n(26)),l=n(10),u=i.default(e=>{const{to:t,...n}=e;return o.default.createElement(r.default,Object.assign({as:"a",href:t,target:"_blank"},n))}).withConfig({displayName:"SocialMediaLink",componentId:"sc-1p2h2mh"})`
    font-size: 1.5em;
    margin-left: 0.125em;
